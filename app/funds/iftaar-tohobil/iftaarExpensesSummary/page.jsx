...
import { useStore } from '../../../lib/store'; // আপনার সঠিক পাথ অনুযায়ী পরিবর্তন করে নিবেন
import { FaArrowDown, FaCalendarAlt, FaLayerGroup, FaTable, FaWallet, FaDownload, FaFilter } from 'react-icons/fa';

export default function IftaarExpensesSummary() {
  ...
  // ১. নির্দিষ্ট বছর ও ইফতার ফান্ডের খরচ (Expense) ফিল্টার করা
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4 md:p-6 space-y-6 print:p-0 print:bg-white print:space-y-5">
      ...
      <div className="bg-white p-4 rounded-2xl border border-orange-100 shadow-sm flex flex-col sm:flex-row justify-between items-center gap-4 print:hidden">
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <FaFilter className="text-orange-500 shrink-0" />
          <span className="text-sm font-bold text-gray-700 whitespace-nowrap">অর্থবছর নির্বাচন:</span>
          <select 
            value={selectedYear} 
            onChange={(e) => setSelectedYear(e.target.value)}
            className="px-3 py-1.5 text-sm border border-orange-200 rounded-xl bg-orange-50/50 font-bold text-gray-800 focus:outline-none focus:ring-2 focus:ring-orange-400"
          >
        ...
        <button 
          ...
          className="w-full sm:w-auto bg-gradient-to-r from-orange-500 to-amber-600 text-white font-bold text-sm px-5 py-2.5 rounded-xl hover:from-orange-600 hover:to-amber-700 transition shadow-sm flex items-center justify-center gap-2"
        >
          <FaDownload />
      ...
      <div className="space-y-6 print:space-y-4">
        ...
        {/* টপ হেডার কার্ড */}
        <div className="bg-gradient-to-r from-red-500 to-rose-600 text-white rounded-3xl p-6 shadow-md flex flex-col sm:flex-row justify-between items-center gap-4 print:bg-none print:text-black print:border print:border-gray-300 print:rounded-xl print:p-3 print:shadow-none">
          <div className="flex items-center gap-4">
            <div className="p-4 bg-white/20 rounded-2xl text-2xl print:hidden">
              <FaArrowDown />
            </div>
            <div>
              <h2 className="text-xl font-bold opacity-90 print:text-sm print:text-gray-700">ইফতার তহবিলের মোট খরচ ({Number(selectedYear).toLocaleString('bn-BD')})</h2>
              <p className="text-xs opacity-75 print:hidden">এই অর্থবছরে হওয়া চূড়ান্ত খরচের হিসাব</p>
            </div>
          </div>
          <div className="text-right">
            <h1 className="text-4xl md:text-5xl font-black print:text-red-600 print:text-2xl">
        ...
        <div className="bg-white p-6 rounded-3xl border border-orange-50 shadow-sm space-y-4 print:p-0 print:border-none print:shadow-none print:avoid-break">
          <h3 className="text-lg font-black text-gray-800 flex items-center gap-2 border-b border-orange-50 pb-3 print:text-xs print:font-bold print:text-gray-800 print:pb-1">
            <FaTable className="text-orange-500 print:hidden" /> ১. আয় ও ব্যয়ের সংক্ষিপ্ত বিবরণী
          </h3>
          <div className="overflow-x-auto rounded-2xl border border-orange-100 print:border-gray-300 print:rounded-lg">
            <table className="w-full text-left border-collapse text-sm print:text-xs">
              <thead>
                <tr className="bg-orange-50/50 text-gray-700 font-bold print:bg-gray-100 print:text-gray-800">
              ...
              <tbody className="divide-y divide-orange-50 font-medium text-gray-600 print:divide-gray-200">
                ...
                <tr className="hover:bg-orange-50/20">
                  <td className="p-4 text-center font-bold text-gray-700 print:p-2">মোট ইফতার ব্যয় (খরচ)</td>
                ...
                <tr className="bg-orange-50/30 font-bold print:bg-gray-50">
                  <td className="p-4 text-center font-black text-gray-800 flex items-center justify-center gap-1 print:p-2 print:font-bold">
                    <FaWallet className="text-orange-600 print:hidden" size={13} /> বর্তমান অবশিষ্ট তহবিল
                  </td>
                  ...
                  <td className="p-4 text-center print:p-2">
                    <span className={`px-3 py-1 text-xs font-bold rounded-full print:p-0 print:bg-none ${
                      ...
                      {financialSummary.netBalance >= 0 ? 'উদ্বৃত্ত' : 'ঘাটতি'}
                    </span>
                  </td>
                </tr>
              </tbody>
        ...
        <div className="bg-white p-6 rounded-3xl border border-orange-50 shadow-sm space-y-4 print:p-0 print:border-none print:shadow-none print:avoid-break">
          <h3 className="text-lg font-black text-gray-800 flex items-center gap-2 border-b border-orange-50 pb-3 print:text-xs print:font-bold print:text-gray-800 print:pb-1">
            <FaLayerGroup className="text-red-500 print:hidden" /> ২. খাত ভিত্তিক খরচের বিবরণী
          </h3>
