...
export default function MosjidFundHome() {
  ...
  // --- লজিক: শুধুমাত্র মসজিদ ফান্ডের ডাটা ফিল্টার ও ক্যালকুলেশন ---
  ...
  const menuItems = [
    ...
    { name: 'দাতা', link: `/funds/${currentFund}/mosjid-doner?fund=${currentFund}`, icon: <FaDonate /> },
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-24 font-sans">
      ...
      {/* Hero Section - Emerald Green Theme for Mosque */}
      <div className="max-w-7xl mx-auto p-4 md:p-10">
        <div className="bg-gradient-to-br from-emerald-600 to-teal-700 text-white rounded-[2.5rem] shadow-2xl shadow-emerald-100 p-8 md:p-14 text-center mb-10 relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
          <StatCard icon={<FaArrowUp />} title="মোট জমা" value={fundData.totalDonation} color="emerald" />
          ...
          <StatCard icon={<FaUsers />} title="দাতা সদস্য" value={fundData.memberCount} color="blue" isCount={true} />
        </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-black text-slate-800 text-sm md:text-lg leading-tight">
                      {t.type === 'donation' || t.type === undefined ? (t.donorName || t.name) : (t.receiverName || t.name || 'খরচের বিবরণ')}
                    </div>
