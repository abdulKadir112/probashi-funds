  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center relative z-10">
        ...
        <h3 className="text-sm md:text-lg font-bold text-gray-800 mt-3 line-clamp-1">
          {member.name}
        </h3>
...
function MembersContent() {
  ...
  // ✅ FIX: useSearchParams removed
  const [currentFund, setCurrentFund] = useState('');

  useEffect(() => {
    const params = new URLSearchParams(window.location.search);
    setCurrentFund(params.get('fund') || '');
  }, []);
      ...
      {selectedMember && (
        <div className="fixed inset-0 bg-indigo-950/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-hidden flex flex-col">
            ...
            <div className="p-5 md:p-8 border-b bg-emerald-900 text-white flex justify-between">
              <div>
                <h2 className="text-lg md:text-2xl font-black">
                  {selectedMember.name}
                </h2>
                <p className="text-emerald-200 text-xs">
                  দানের বিস্তারিত তালিকা
                </p>
              </div>
            ...
            <div className="p-4 overflow-y-auto space-y-2 bg-gray-50">
                ...
                <div key={i} className="bg-white p-3 rounded-xl border flex justify-between">
                  <div>
                    <p className="text-sm font-bold">
                      {d.fundId ? (fundNameMap[d.fundId] || d.fundId) : 'সাধারণ দান'}
                    </p>
                  </div>
            ...
            <div className="p-5 border-t flex justify-between">
              ...
              <span className="font-black text-emerald-900">
                ৳ {selectedMember.totalDonated.toLocaleString('bn-BD')}
              </span>
            </div>
